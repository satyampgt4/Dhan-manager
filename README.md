...
**1.**  Fork [this](https://github.com/satyampgt4/dhan-manager.git) repository.
...
```
git clone  https://github.com/<your_user_name>/dhan-manager.git
```
...
```
git remote add upstream https://github.com/satyampgt4/dhan-manager.git 
```
